...
from erptechglobal_hr.erp_tech_global_hr.api.employee import get_allowed_locations, get_employee_devices
from erptechglobal_hr.erp_tech_global_hr.api.api import gen_response
